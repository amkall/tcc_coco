function RealCodeGA (problem, lower_bounds, upper_bounds, num_integer_vars, num_constraints, budget)  
    ...
    for ii=1:1:generation
        ...
        if num_constraints > 0
            cocoEvaluateConstraint(problem, Best_F);
        end
        cocoEvaluateFunction(problem, Best_F);
    end
    plot(Best_F,'b');
    pause(0.1)
    xlabel('Generation')
