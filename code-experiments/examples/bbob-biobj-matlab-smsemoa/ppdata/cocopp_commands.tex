...
\providecommand{\cocoversion}{\hspace{\textwidth}\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.4, hv-hash=ff0e71e8cd978373}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{SMSEMOA on bbob-biobj{}}
\providecommand{\algfolder}{SMSEMOA_on_bbob-biobj/}
...
%
        ...
        evaluations) divided by the \ERT\ of the best algorithm from BBOB 2016 in #1. This \ERT\
...
%
        ...
        %
        Shown is the \ERT\ for fixed values of $\DI = 10^k$ with $k$ given
        in the legend.
...
%
         ...
         (from right to left cycling cyan-magenta-black\dots) and final $\DI$-value (red),
